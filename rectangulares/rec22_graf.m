...
[X,Y,Z,U,V,Potencial,Campo,Densidad] = rec22_serie(a,b,1);
surf(X,Y,Potencial);
...
[X,Y,Z,U,V,Potencial,Campo,Densidad] = rec22_serie(a,b,5);
surf(X,Y,Potencial);
...
[X,Y,Z,U,V,Potencial,Campo,Densidad] = rec22_serie(a,b,10);
surf(X,Y,Potencial);
...
[X,Y,Z,U,V,Potencial,Campo,Densidad] = rec22_serie(a,b,20);
surf(X,Y,Potencial);
