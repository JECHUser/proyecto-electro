...
% graficar superficie
[X,Y,Z,U,V,Potencial,Campo,Densidad] = rec12_serie(a,b,1); % llama funcion rec12_serie.m
surf(X,Y,Potencial);
colorbar
...
[X,Y,Z,U,V,Potencial,Campo,Densidad] = rec12_serie(a,b,5);
surf(X,Y,Potencial);
colorbar
...
[X,Y,Z,U,V,Potencial,Campo,Densidad] = rec12_serie(a,b,10);
surf(X,Y,Potencial);
colorbar
...
[X,Y,Z,U,V,Potencial,Campo,Densidad] = rec12_serie(a,b,20);
surf(X,Y,Potencial);
colorbar
...
subplot(2,2,1)
[X,Y,Z,U,V,Potencial,Campo,Densidad] = rec12_serie(a,b,1);
quiver3(X,Y,Z,U,V,Z)
